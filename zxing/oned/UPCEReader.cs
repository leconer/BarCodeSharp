...
namespace com.google.zxing.oned
{
	...
	public sealed class UPCEReader:UPCEANReader
	{
		...
		protected internal override int? decodeMiddle(BitArray row, int[] startRange, System.Text.StringBuilder result)
		{
			...
			bool success = determineNumSysAndCheckDigit(result, lgPatternFound);
		...
		private static bool determineNumSysAndCheckDigit(System.Text.StringBuilder resultString, int lgPatternFound)
		{
